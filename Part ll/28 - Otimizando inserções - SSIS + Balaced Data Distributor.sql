...
CREATE DATABASE [TestSSIS_D_Drive]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'TestSSIS_D_Drive', FILENAME = N'd:\Program Files\Microsoft SQL Server\MSSQL15.SQL2019CTP2_4\MSSQL\DATA\TestSSIS_D_Drive.mdf' , SIZE = 10485760KB , FILEGROWTH = 1048576KB )
 LOG ON 
( NAME = N'TestSSIS_D_Drive_log', FILENAME = N'd:\Program Files\Microsoft SQL Server\MSSQL15.SQL2019CTP2_4\MSSQL\DATA\TestSSIS_D_Drive_log.ldf' , SIZE = 5283840KB , FILEGROWTH = 1048576KB )
GO
